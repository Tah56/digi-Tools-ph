...
const RatingSection = () => {
    return (
        <div>
            <div className='bg-linear-to-r from-[#4F39F6] to-[#9514FA] py-14 md:flex items-center justify-evenly flex-wrap '>
                 ...
                 <div className='items-center flex flex-col text-white  lg:border-r lg:border-l  py-10 md:px-40 space-y-2.5'>
